...
import { FiCalendar, FiChevronLeft, FiChevronRight, FiPhoneCall } from 'react-icons/fi'
import 'swiper/css'
...
const slides = [
  {
    ...
    description: 'Experienced doctors, modern equipment and compassionate care for every patient.',
  },
  {
    image: hero2,
    ...
    description: 'Instant trauma responses and emergency medical care paired with advanced diagnostic units.',
  },
  {
    image: hero3,
    ...
    description: 'Elevating local healthcare with advanced treatments and specialist doctors.',
  },
]
  ...
  return (
    <section className="group relative">
      ...
      >
              ...
              <div className="relative h-full">
                ...
                <div className="relative z-10 flex h-full items-center">
                  <div className="mx-auto w-full max-w-7xl px-6">
                    <span
                      className={`inline-block rounded-full border border-teal-400 bg-teal-500/20 px-5 py-2 text-sm font-bold text-teal-300 transition-all duration-700 ${
                    ...
                    <h1
                      className={`mt-6 max-w-3xl text-4xl font-black leading-tight text-white transition-all duration-700 md:text-6xl ${
        ...
        <div className="hero-pagination absolute bottom-8 z-20 flex w-full justify-center" />
      </Swiper>
